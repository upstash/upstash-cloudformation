...
1. Write the JSON schema describing your resource, [upstash-databasesv1-database.json](./upstash-databasesv1-database.json)
2. Implement your resource handlers in [handlers.ts](./upstash-databasesv1-database/handlers.ts)

> Don't modify [models.ts](./upstash-databasesv1-database/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
