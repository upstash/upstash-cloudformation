...
1. Write the JSON schema describing your resource, [upstash-kafkav1-cluster.json](./upstash-kafkav1-cluster.json)
2. Implement your resource handlers in [handlers.ts](./upstash-kafkav1-cluster/handlers.ts)

> Don't modify [models.ts](./upstash-kafkav1-cluster/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
