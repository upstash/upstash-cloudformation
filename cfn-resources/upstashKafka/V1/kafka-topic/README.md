...
1. Write the JSON schema describing your resource, [upstash-kafkav1-topic.json](./upstash-kafkav1-topic.json)
2. Implement your resource handlers in [handlers.ts](./upstash-kafkav1-topic/handlers.ts)

> Don't modify [models.ts](./upstash-kafkav1-topic/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
